(** Establishing database connections, plus the URL/credential plumbing and
    driver-error diagnostics that support it. Internal to [migra]; the public
    lifecycle and display helpers live in {!Database}. *)
